...
def get_options(args=None):
    ...
    parser.add_argument('--test_instance', default=None)
...
# def get_active_search_options(args=None, cities = 100, model_path=None, test_instance=None, cover=7):
#     parser = argparse.ArgumentParser(
#         description="Attention based model for solving the Travelling Salesman Problem with Reinforcement Learning")
#
#     # Data, 100,256,160000
#     parser.add_argument('--problem', default='csp', help="The problem to solve, default 'tsp'")
#     parser.add_argument('--graph_size', type=int, default=cities, help="The size of the problem graph")
#     parser.add_argument('--batch_size', type=int, default=256, help='Number of instances per batch during training')
...
#     parser.add_argument('--exp_beta', type=float, default=0.8,
#                         help='Exponential moving average baseline decay (default 0.8)')
#     parser.add_argument('--baseline', default="constant",
#                         help="Baseline to use: 'rollout', 'critic' or 'exponential'. Defaults to no baseline.")
#     parser.add_argument('--bl_alpha', type=float, default=0.05,
#                         help='Significance in the t-test for updating rollout baseline')
#     parser.add_argument('--bl_warmup_epochs', type=int, default=None,
...
#     parser.add_argument('--log_dir', default='logs', help='Directory to write TensorBoard information to')
#     parser.add_argument('--run_name', default='run', help='Name to identify the run')
#     parser.add_argument('--output_dir', default='active_outputs', help='Directory to write output models to')
#     parser.add_argument('--epoch_start', type=int, default=0,
#                         help='Start at epoch # (relevant for learning rate decay)')
#     parser.add_argument('--checkpoint_epochs', type=int, default=1,
#                         help='Save checkpoint every n epochs (default 1), 0 to save no checkpoints')
#     parser.add_argument('--load_path', default=model_path, help='Path to load model parameters and optimizer state from')
#     parser.add_argument('--resume', default=None, help='Resume from previous checkpoint file')
#     # parser.add_argument('--resume', help='Resume from previous checkpoint file')
#     parser.add_argument('--no_tensorboard', action='store_true', help='Disable logging TensorBoard files')
#     parser.add_argument('--no_progress_bar', action='store_true', help='Disable progress bar')
#     parser.add_argument('--head', type=int, default=8, help='nums of head')
#     parser.add_argument('--test_instance', default=test_instance)
